...
const ProjectsSection = () => {
  const [activeFilter, setActiveFilter] = useState<'all' | 'web' | 'mobile' | 'infrastructure' | 'other'>('all');
      ...
      <div className="container-max section-padding">
        ...
        >
          ...
          <p className="text-lg text-dark-600 max-w-2xl mx-auto">
            A showcase of my recent work, including web applications, cloud infrastructure, 
            and performance optimizations that deliver real business value.
          </p>
        ...
        >
          <AnimatePresence mode="wait">
            {filteredProjects.map((project, index) => (
              ...
              >
                <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 h-full">
                  {/* Featured Badge */}
                  {project.featured && (
                  ...
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: hoveredProject === project.projectName ? 1 : 0 }}
